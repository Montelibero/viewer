...
export async function init(params, i18n) {
    ...
    if (btnStellarLab) {
        btnStellarLab.href = `https://lab.stellar.org/smart-contracts/contract-explorer?$=smartContracts$explorer$contractId=${contractId}`;
    }

    const btnStellarExpert = document.getElementById('btn-stellar-expert');
    if (btnStellarExpert) {
